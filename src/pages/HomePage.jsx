...
export default function HomePage() {
  ...
  const tuesday = serviceTimes.find(s => s.day === 'Tuesday')
  ...
  return (
    <div className="home-page" ref={revealRef}>
      ...
      <div className="home-body">
        ...
        <section className="times-section reveal">
          ...
          <div className="times-grid">
            ...
            {tuesday && (
              <div className="time-card-alt card">
                <p className="time-day-alt">{tuesday.day}</p>
                <p className="time-clock-alt">{tuesday.time}</p>
                <p className="time-name-alt">{tuesday.name}</p>
              </div>
            )}
          </div>
        </section>
      ...
      <style>{`
        ...
        .times-grid { display: grid; grid-template-columns: 1fr 1fr; gap: var(--sp-3); }
        ...
        .time-card-alt { padding: var(--sp-5); text-align: center; }
        .time-day-alt { font-size: var(--fs-xs); font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--clr-yellow); }
        .time-clock-alt { font-family: var(--font-display); font-size: var(--fs-2xl); color: var(--clr-text); margin: var(--sp-1) 0; }
        .time-name-alt { font-size: var(--fs-sm); color: var(--clr-text-muted); }
