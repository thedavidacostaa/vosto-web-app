...
export const externalLinks = {
  ...
  thirdWaveConRegistration: 'https://events.victoryoutreach.org/Events/Entry/fd616b74-c626-44d8-b49d-f32987961cc3',
}
...
export const featuredEvent = {
  title: 'Third Wave Con 2026',
  date: 'July 28 – July 31',
  time: '7:00 PM (Opening Session, Tuesday)',
  location: 'Angelus Temple, 1100 Glendale Blvd, Los Angeles, CA 90026',
  description: "Join us for Third Wave Con 2026, hosted at Angelus Temple in Los Angeles. Early Bird tickets are $280, General tickets are $320 after July 17 at 5 PM PST. Transportation and lodging are not included, and the event is not open to children.",
  registerUrl: externalLinks.thirdWaveConRegistration,
}
